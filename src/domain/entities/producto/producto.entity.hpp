...
class ProductoBuilder
{
   ...
   public:
    ...
    {
        if (id <= 0) return "ID inválido: debe ser mayor a 0.";
        if (nombre == nullptr || nombre[0] == '\0') return "Nombre inválido: no puede estar vacío.";
        if (codigo == nullptr || codigo[0] == '\0') return "Código inválido: no puede estar vacío.";
        if (descripcion == nullptr || descripcion[0] == '\0')
            return "Descripción inválida: no puede estar vacía.";
        if (precio < 0) return "Precio inválido: debe ser mayor o igual a 0.";
        if (stock < 0) return "Stock inválido: debe ser mayor o igual a 0.";
        if (stockMinimo < 0) return "Stock mínimo inválido: debe ser mayor o igual a 0.";
        if (totalVendido < 0) return "Total vendido inválido: debe ser mayor o igual a 0.";
        if (idProveedor <= 0) return "ID de proveedor inválido: debe ser mayor a 0.";
