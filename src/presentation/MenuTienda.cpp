...
void MenuTienda::mostrarResumenTienda()
{
    if (!leerTienda(tienda)) {
        cout << CLEAR_SCREEN << COLOR_RED
             << "Error: No se pudo leer el registro de tienda." << COLOR_RESET
             << endl;
        return;
    }
    ...
    std::cout << COLOR_CYAN
              << "========================================" << COLOR_RESET
              << std::endl;
    std::cout << COLOR_CYAN << "         RESUMEN DE TIENDA             "
              << COLOR_RESET << std::endl;
    std::cout << COLOR_CYAN
              << "========================================" << COLOR_RESET
              << std::endl;
    std::cout << COLOR_YELLOW << "ID: " << COLOR_RESET << tienda.id
              << std::endl;
    std::cout << COLOR_YELLOW << "Nombre: " << COLOR_RESET << tienda.nombre
              << std::endl;
    std::cout << COLOR_YELLOW << "RIF: " << COLOR_RESET << tienda.rif
              << std::endl;
    ...
    std::cout << COLOR_YELLOW << "Clientes activos: " << COLOR_RESET
              << tienda.totalClientesActivos << std::endl;
